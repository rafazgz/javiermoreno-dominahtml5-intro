...
var FormularioCtrl = function() {
    ...
    History.Adapter.bind(window, 'statechange', function(){
        ...
        if (estado.data.nombrePantalla == undefined){
...
FormularioCtrl.prototype.mostrarFicha = function(bicicleta) {
    ...
    History.pushState(
        { nombrePantalla : 'Ficha'},
        'Ficha bicicleta ' + bicicleta.modelo,
        'ficha.html'
    );
...
FormularioCtrl.prototype.mostrarFormulario = function() {
    $('#ficha').fadeOut(300, function() {
